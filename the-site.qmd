...
p <- ggplot() +
  ...
  # purposely plotting first so they're hidden behind the tree circles
  ## between Trees
  ...
  geom_circle(data = circles_df,
              aes(x0 = x, y0 = y, r = r),
              color = "black", fill = "olivedrab4", size = 0.5) +
  # Tree labels
...
ggsave("figures/the-site.png", p, width = 8, height = 8, dpi = 400)
p
```
